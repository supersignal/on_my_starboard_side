 ...
 */
export const createApiKeyRateLimit = (windowMs: number = 15 * 60 * 1000, max: number = 100) => {
  return rateLimit({
    windowMs,
    max,
 ...
 */
export const searchRateLimit = createApiKeyRateLimit(
  15 * 60 * 1000, // 15분
  50 // 최대 50회 검색
);
 ...
 */
export const generalRateLimit = createApiKeyRateLimit(
  15 * 60 * 1000, // 15분
  200 // 최대 200회 요청
);
 ...
 * 헬스체크용 Rate Limiting
 */
export const healthRateLimit = createApiKeyRateLimit(
  1 * 60 * 1000, // 1분
  10 // 최대 10회
);
